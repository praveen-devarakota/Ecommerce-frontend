    ...
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-3 text-lg font-medium">Loading Accessories...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-slate-100 py-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Power up your tech with smart accessories built for performance and convenience
          </p>
          <div
