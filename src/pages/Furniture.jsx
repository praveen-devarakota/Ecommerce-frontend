    ...
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-3 text-lg font-medium">Loading Furniture...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-slate-100 py-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Crafted for comfort, styled for your space — furniture that feels like home.
          </p>
          <div
        ...
        {!Array.isArray(products) || products.length === 0 ? (
          <div className="text-center text-gray-500 text-lg py-20">
            <div className="bg-white rounded-2xl shadow-sm p-12 max-w-md mx-auto">
              ...
              <p className="text-gray-500">Check back soon for exciting Furniture deals!</p>
            </div>
          </div>
        ) : (
        <div
